...
Code to fill in:
   ...
   peg4.c0         - Added the forward-backward method
   peg5.c0
Data:
...
% cc0 -d -w -o peg4 peg-client.c0 lib/*.c0 peg4.c0 peg-main.c0
% ./peg4 german.txt

% cc0 -d -w -o peg5 peg-client.c0 lib/*.c0 peg5.c0 peg-main.c0
% ./peg5 german.txt
...
% cc0 -w -o peg4 -r unsafe -c-O2 peg-client.c0 lib/*.c0 peg4.c0 peg-main.c0
% ./peg4 english.txt

% cc0 -w -o peg5 -r unsafe -c-O2 peg-client.c0 lib/*.c0 peg5.c0 peg-main.c0
% ./peg5 english.txt

% cc0 -d -w -o pegmark peg-client.c0 lib/*.c0 pegmark.c0 peg-main.c0
% ./ pegmark english.txt
==========================================================
